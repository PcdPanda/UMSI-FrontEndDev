...
function HomeScreen({navigation}) {
  ...
  let [switchValue, updateSwitch] = useState(false);
  useEffect(()=>{
    ...
    <View style={styles.container}>
      <View style={styles.title}>
        <Switch value={switchValue} onValueChange={
          ...
          dataModel.changeShow();
        }}/>
        <Text style={styles.listItemText}>  Hide Completed Items</Text>
      </View>
        ...
        <FlatList
          ...
          renderItem={({item})=>{
            ...
            <View style={styles.listItem}>
              <CheckBox checked={item.check} onPress={()=>dataModel.checkItem(item.key)}/>
